...
<!--=======-->
  <!--<div class="ml-4" id="tranDataIndex">-->
    <!--<v-layout row wrap>-->
      <!--<v-flex md8 lg8>-->
        <!--&lt;!&ndash;<tran-check-flow-info v-if="optKey==3"></tran-check-flow-info>&ndash;&gt;-->
        <!--&lt;!&ndash;<tran-release-flow-info v-if="optKey==4"></tran-release-flow-info>&ndash;&gt;-->
        <!--&lt;!&ndash;复核流程信息&ndash;&gt;-->
        <!--<v-card class="mt-4 ">-->
          <!--<v-toolbar color="primary lighten-2" dark scroll-off-screen scroll-target="#scrolling-techniques" flat>-->
            <!--&lt;!&ndash;<v-icon>call_split</v-icon>&ndash;&gt;-->
...
<!--=======-->
      ...
      <!--<v-flex md4 lg4>-->
        ...
        <!--&lt;!&ndash;        <v-card class="ml-4 mt-4 elevation-4 radiusDc">-->
                  <!--<v-card-media src="/static/avatar/prod1.jpg" style="margin-left: 29%;margin-right: 30%">-->
                  <!--</v-card-media>-->
                  <!--<v-layout>-->
                    <!--<v-subheader class="showMsg" style="color: #00b0ff">产品代码:</v-subheader>-->
        ...
        <!--<v-tabs fixed-tabs v-if="isTable == false">-->
          ...
          <!--<v-tabs-items v-model="model">-->
            <!--<v-tab-item v-for="i in diffList" :key="i">-->
              ...
              <!--&lt;!&ndash;<prod-diff v-if="i=='利息信息'" :prodData="prodEventCycle"></prod-diff>&ndash;&gt;-->
