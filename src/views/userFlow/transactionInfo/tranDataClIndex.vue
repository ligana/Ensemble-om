        ...
        <v-layout row wrap>
                        ...
                        <v-stepper-items>
                            ...
                            <v-stepper-content step="2">
                                <v-layout wrap>
                                    ...
                                    <v-flex md10 lg10>
                                        <v-text-field class="primary--text mx-1 textBox" label="" disabled="false"
                                                      name="title" v-model="checkInfo.userId" single-line hide-details>
                                        </v-text-field>
                                    </v-flex>
                                    <v-flex xs12 md2 lg2>
                                    ...
                                    <v-flex md10 lg10>
                                        <v-switch color="success" style="margin-top: 8px" hide-details value="Y"
                                                  :label="`${checkInfo.isApproved==='Y'?'通过':'驳回'}`"
                                                  v-model="checkInfo.isApproved"></v-switch>
                                    </v-flex>
                                    <v-flex xs12 md2 lg2>
                    ...
                    <v-stepper v-model="e1" style="color: white" v-if="optKey == 4">
                        ...
                        <v-stepper-content step="2">
                            <v-layout wrap>
                                ...
                                <v-flex md10 lg10>
                                    <v-switch color="success" style="margin-top: 8px" hide-details value=true
                                              disabled="false" v-model="releaseFlowInfo.flowCheckInfo.isApproved"
                                              :label="`${releaseFlowInfo.flowCheckInfo.isApproved==='Y'?'通过':'驳回'}`"></v-switch>
                                </v-flex>
                                <v-flex xs12 md2 lg2>
                                    <v-subheader class="descClass">复核意见:</v-subheader>
                                </v-flex>
                        ...
                        <v-stepper-content step="3">
                            <v-layout wrap>
                                ...
                                <v-flex md10 lg10>
                                    <v-text-field class="primary--text mx-1 textBox" label="" disabled="false"
                                                  name="title" v-model="releaseInfo.userId" single-line hide-details>
                                    </v-text-field>
                                </v-flex>
                                <v-flex xs12 md2 lg2>
                                ...
                                <v-flex md10 lg10>
                                    <v-text-field class="primary--text mx-1 textBox" label="" disabled="false"
                                                  name="title" v-model="releaseInfo.date" value="2018/09/07" single-line
                                                  hide-details>
                                    </v-text-field>
                                </v-flex>
                                <v-flex xs12 md2 lg2>
                                ...
                                <v-flex md10 lg10>
                                    <v-switch color="success" style="margin-top: 8px " hide-details value="Y"
                                              :label="`${releaseInfo.isApproved==='Y'?'通过':'驳回'}`"
                                              v-model="releaseInfo.isApproved"></v-switch>
                                </v-flex>
                                <v-flex xs12 md2 lg2>
            ...
            <v-flex md4 lg4>
                <v-card class="ml-4 mt-4 elevation-4 radiusDc">
                    ...
                    <v-layout>
                        <v-subheader style="font-size: x-large;font-style: inherit;margin-left: 5%;color: #00b0ff">
                            产品名称:
                        </v-subheader>
                        <v-subheader style="font-size: x-large;font-style: inherit;margin-left: 0%;color: #00b0ff">
                            {{prodDesc}}
                        </v-subheader>
                    </v-layout>
                    <v-layout>
