    ...
    <a-spin tip="Loading..." size="large" :spinning="spinning" class="RB">
        <v-layout row wrap class="app-container pt-4">
            <v-flex lg9 sm9 class="v-card" style=" border:1px solid #DCE1E7!important;">
                ...
                <!--定期产品界面展示-->
                <v-tabs v-if="isT" slot="extension" v-model="activeName" grow show-arrows>
                ...
                <!--非定期界面展示-->
                <v-tabs v-else slot="extension" v-model="activeName" grow show-arrows>
...
<!--=======-->
                <!--<v-tabs-items v-model="activeName" class="white textProd">-->
                    <!--<v-tab-item v-for="i in prodInfo" :key="i.pageCode">-->
                        <!--<base-prod :showEdit="showEdit" v-if="i.pageCode=='BASE'"-->
                                   <!--:prodTypeCode="prodData.prodType.prodType" :prodType="prodData.prodType"-->
                                   <!--:prodDefines="prodData.prodDefines" :disablePower="disablePower"-->
                                   <!--tags="BASE"></base-prod>-->
                        <!--<base-prod :showEdit="showEdit" v-if="i.pageCode=='CONTROL'"-->
                                   <!--:prodTypeCode="prodData.prodType.prodType" :prodDefines="prodData.prodDefines"-->
                                   <!--tags="CONTROL" :disablePower="disablePower"></base-prod>-->
                        <!--<base-prod :showEdit="showEdit" v-if="i.pageCode=='APPLY'"-->
                                   <!--:prodTypeCode="prodData.prodType.prodType" :prodDefines="prodData.prodDefines"-->
                                   <!--tags="APPLY" :disablePower="disablePower"></base-prod>-->
                        <!--<base-prod :showEdit="showEdit" v-if="i.pageCode=='INT'"-->
                                   <!--:prodTypeCode="prodData.prodType.prodType" :prodDefines="prodData.prodDefines"-->
                                   <!--tags="INT" :disablePower="disablePower"></base-prod>-->
                        <!--<base-prod :showEdit="showEdit" v-if="i.pageCode=='OPEN'"-->
                                   <!--:prodTypeCode="prodData.prodType.prodType" :prodDefines="OPEN" tags="OPEN"-->
                                   <!--:disablePower="disablePower"></base-prod>-->
                        <!--<base-prod :showEdit="showEdit" v-if="i.pageCode=='CLOSE'"-->
                                   <!--:prodTypeCode="prodData.prodType.prodType" :prodDefines="CLOSE" tags="CLOSE"-->
                                   <!--:disablePower="disablePower"></base-prod>-->
                        <!--<base-prod :showEdit="showEdit" v-if="i.pageCode=='CRET'"-->
                                   <!--:prodTypeCode="prodData.prodType.prodType" :prodDefines="CRET" tags="CRET"-->
                                   <!--:disablePower="disablePower"></base-prod>-->
                        <!--<base-prod :showEdit="showEdit" v-if="i.pageCode=='DEBT'"-->
                                   <!--:prodTypeCode="prodData.prodType.prodType" :prodDefines="DEBT" tags="DEBT"-->
                                   <!--:disablePower="disablePower"></base-prod>-->
...
<!--&gt;>>>>>> styleUi2.0-->
            ...
            <v-flex lg3 sm3 class="v-card pl-3">
                <v-card class="">
                    <v-card-text class="boartop_box">
                        <down-action v-if="pendFlag==0" v-bind:editShow="editShow" v-on:listenToCopy="listenToCopy"
                                     v-on:saveProd="saveProd" v-on:tempProd="tempProd"></down-action>
                ...
                <v-window v-model="onboarding" :class="depositTree" class="">
                    ...
                    <v-window-item v-for="n in length" :key="`card-${n}`" class="">
                        <prod-list-form v-if="n == 2 || windowShow == 0" v-bind:prodClass="prodClass"
                                        v-on:listenToProdList="listenToProdList"></prod-list-form>
                        <dc-treeAttr v-if="n == 1 && windowShow != 0" v-model="tree" :options="treeOptions"
                                     labelDesc="产品参数" style="background-color: #ff0405;"></dc-treeAttr>
                    </v-window-item>
                </v-window>
            </v-flex>
        </v-layout>
...
<script>
    ...
    export default {
        ...
        created () {
            //通过产品类型  获取产品属性为定期产品或者活期产品   定期产品：隐藏形态转移，收费定义页签
...
//                this.baseAttr=baseAttr==false?true:false;
            ...
            useAddClick(val) {
                ...
                for (let i = 0; i < val.length; i++) {
                    ...
                    if(addColumnPageCode === "DESC" || addColumnPageCode === "CHARGE" || addColumnPageCode === "RATEINFO" || addColumnPageCode === "ACCOUNTING"){
                        showFlag = 1
                        this.$swal({
                            allowOutsideClick: false,
                            type: 'info',
