            ...
            <v-flex lg9 sm9 class="v-card" style="background: #fff;">
                <v-toolbar dark tabs>
                    <v-tooltip bottom>
                        ...
                        <span style="background: #3C73E6;padding: 8px;margin: 0 -8px;border-radius: 2px">{{collectDesc}}</span>
                    </v-tooltip>
                    ...
                    <v-tooltip bottom>
                        ...
                        <span style="background: #3C73E6;padding: 8px;margin: 0 -8px;border-radius: 2px">{{editDesc}}</span>
                    </v-tooltip>
                    <v-tooltip bottom>
                        <v-btn flat icon slot="activator" @click="refreshClick" :color="editColor">
                            <v-icon>refresh</v-icon>
                        </v-btn>
                        <span style="background: #3C73E6;padding: 8px;margin: 0 -8px;border-radius: 2px">刷新</span>
                    </v-tooltip>
                </v-toolbar>
